...
/**
    Copy of the LINK token to mock out transfers
 */
...
contract ERC677 is ERC20 {
    ...
    //event Transfer(address indexed from, address indexed to, uint value, bytes data); Removed due to double Transfer event, messes with the ABI
}
